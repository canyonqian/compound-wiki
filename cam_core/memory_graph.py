...
class MemoryGraph:
    ...
    def generate_mermaid(self, center_node_id: str = None, max_nodes: int = 20) -> str:
        """
        ...
        if center_node_id:
            ...
            sorted_nodes = sorted(self._nodes.values(), key=lambda n: n.weight, reverse=True)[:max_nodes]
