...
class MemoryMCPHandler:
    ...
    def __init__(self, wiki_path: str = None):
        self.wiki_path = wiki_path or os.environ.get("WIKI_PATH", "./wiki")
                ...
                response = {
                    ...
                    "result": {
                        "tools": [
                            ...
                            {
                                "name": "wiki_status",
                                "description": ("Get statistics and health status of the memory/Wiki system."),
                                "inputSchema": {
                                    "type": "object",
                                    "properties": {},
                                },
                            ...
                            {
                                "name": "search",
                                "description": ("Full-text search across all Wiki pages for specific terms or topics."),
                                "inputSchema": {
                                    "type": "object",
                                    "properties": {
                                        "query": {
                            ...
                            },
                            {
                                ...
                                "inputSchema": {
                                    ...
                                    "properties": {
                                        "directory": {
                                            "type": "string",
                                            "description": ("Filter: concept|entity|synthesis"),
                                        },
                                    },
                                },
                            },
                            {
                                "name": "read_page",
                                "description": ("Read the full content of a specific Wiki page."),
                                "inputSchema": {
                                    "type": "object",
                                    "properties": {
                                        "path": {
                                            "type": "string",
                                            "description": ("Page relative path, e.g. 'concept/redis.md'"),
                                        },
                                    },
                                    "required": ["path"],
                                },
