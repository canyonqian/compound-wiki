...
logger = logging.getLogger("compound_wiki.scheduler")
...
class TaskScheduler:
    """
    Lightweight scheduler for Compound Wiki automation.
    ...
    def _do_summary(self) -> str:
        ...
        lines = [
            ...
            f"\n---\n*Auto-generated by Compound Wiki Scheduler*",
        ]
        text = "\n".join(lines)
